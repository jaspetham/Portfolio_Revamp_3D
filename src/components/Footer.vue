...
<template>
  <footer class="footer-menu">
    <ul class="menu-items flex items-center justify-center flex-wrap gap-y-6">
      ...
      <div class="flex items-center gap-12 justify-center">
          <li class="menu-item icon">
            <a href="https://github.com/jaspetham" target="_blank">
              <svg
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li class="menu-item icon">
            <a href="https://www.linkedin.com/in/jasper-tham/" target="_blank">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
...
.menu-item.icon {
  ...
  a {
    ...
    padding: 2px;
    svg {
      width: clamp(10px, 10dvh, 48px);
      height: clamp(10px, 10dvh, 48px);
    }
  }
}
@media only screen and (max-width: 801px) {
  ...
  a {
    svg {
      width: clamp(10px, 10dvh, 30px);
      height: clamp(10px, 10dvh, 30px);
    }
  }
}
}
